...
class Player:
    def __init__(self):
        ...
        self.image = pygame.transform.flip(self.image, flip_x=True, flip_y=False) # 将玩家图片旋转-15度，增加视觉动感
    ...
    def update_scroll(self):
        ...
        while len(self.platforms) < 8: # 保持屏幕上至少有8个平台
            ...
            if Utils.hit_probability(Spring.probability): # 根据弹簧的生成概率决定是否在新平台上生成弹簧
                ...
                rocket = Rocket(new_platform)
                new_platform.item = rocket # 将火箭作为平台的一个属性，方便后续碰撞检测和更新
